...
arg2 <- ifelse(
  test = (hmin_est1 <= Hora & Hora < hmax_est1),
...
faltante1 <- which(is.na(arg1))
faltante2 <- which(is.na(arg2))
faltante3 <- which(is.na(arg3))

(arg_est1 <- c(arg1[-faltante1], arg2[-faltante2], arg3[-faltante3]))
...
arg2 <- ifelse(
  test = (hmin_est2 <= Hora & Hora < hmax_est2),
...
(arg_est2 <- c(arg1[-faltante1], arg2[-faltante2], arg3[-faltante3]))
